...
The climbing and descending flight test was the test with the most associated uncertainty. The climbing testing appears to have been conducted properly and the results mostly match with the POH. The descending or gliding performance test was unsuccessful. Parsing this testing out of the recorded data provded to be challenging and the testing identified in at least 2 sets of flight data files does not appear to have been conducted properly or the data was corrupted.
